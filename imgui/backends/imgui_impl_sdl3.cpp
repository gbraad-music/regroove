...
bool ImGui_ImplSDL3_ProcessEvent(const SDL_Event* event)
{
    ...
    switch (event->type)
    {
        ...
        {
            // Multi-touch support: Convert finger events to mouse events with pointer IDs
            // Get window size to convert normalized coordinates (0-1) to pixels
...
void ImGui_ImplSDL3_Shutdown()
{
    ...
    // platform_io.ClearPlatformHandlers();  // Removed: Not available in this ImGui version
    IM_DELETE(bd);
}
